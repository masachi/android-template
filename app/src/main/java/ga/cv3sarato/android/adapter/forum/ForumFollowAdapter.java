...
public class ForumFollowAdapter extends BaseRecyclerAdapter<ForumPostsEntity.ForumItem> {
    ...
    public ForumFollowAdapter(Context context, List<ForumPostsEntity.ForumItem> data, int layoutId) {
    ...
    @OnClick({R.id.forum_item_top_btn, R.id.forum_item_delete_btn, R.id.forum_item_follow_btn, R.id.forum_item_comment_btn, R.id.forum_item_like_btn})

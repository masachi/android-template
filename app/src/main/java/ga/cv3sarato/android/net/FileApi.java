...
public class FileApi {
    ...
    private FileApi(Interceptor interceptor) {
    ...
    public static FileApi defaultInstance(){
        if(api == null) {
            api = new FileApi();
        }
    ...
    public static FileApi getInstance(HttpHeaderInterceptor interceptor) {
        api = null;
        return new FileApi(interceptor);
    }

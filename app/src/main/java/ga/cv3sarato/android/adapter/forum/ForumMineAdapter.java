...
public class ForumMineAdapter extends BaseRecyclerAdapter<ForumPostsEntity.ForumItem> {
    ...
    public ForumMineAdapter(Context context, List<ForumPostsEntity.ForumItem> data, int layoutId) {

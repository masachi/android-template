...
public class TripCreateEntity {

    @SerializedName("content")
    @Required(field = R.string.trip_create_field_content)
    private String content;

    @SerializedName("address")
    @Required(field = R.string.trip_create_field_address)
    ...
    @Required(field = R.string.trip_create_field_start_time)
    private String startTime;

    @SerializedName("end_time")
    @Required(field = R.string.trip_create_field_end_time)
    private String endTime;

    @SerializedName("days")
    @Required(field = R.string.trip_create_field_days)
    private float days;
    ...
    @Required(field = R.string.trip_create_field_managers)

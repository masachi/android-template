...
public class ApplyPageEntity {

    public ApplyPageEntity(PaginationEntity pagination, String keywords) {
        this.pagination = pagination;
        this.keywords = keywords;
    }

    public ApplyPageEntity(PaginationEntity pagination, String keywords, List<SortEntity> sorts) {
        this.pagination = pagination;
        this.keywords = keywords;
        this.sorts = sorts;
    }

    public ApplyPageEntity(PaginationEntity pagination, HashMap<String, Object> filters, List<SortEntity> sorts) {
        this.pagination = pagination;
        this.filters = filters;
        this.sorts = sorts;
    }

    public ApplyPageEntity(PaginationEntity pagination, String keywords, HashMap<String, Object> filters, List<SortEntity> sorts) {
        this.pagination = pagination;
        this.keywords = keywords;
        this.filters = filters;
        this.sorts = sorts;
